...
public class ModConfiguration
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        configuration.getCategory("4_bottlesperbucket").setComment("Change the maximum milk bottles you can get from crafting. (min 1, max 8)");
        ...
        throwableEffectBlacklist = configuration.get("5_effectblacklist", "Potion ID Blacklist", new int[0]).getIntList();
