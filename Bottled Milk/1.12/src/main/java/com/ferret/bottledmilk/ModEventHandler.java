...
public class ModEventHandler
{
    ...
    {
        if(event.getTarget() instanceof EntityCow && event.getEntityPlayer().getHeldItem(event.getHand()).getItem().equals(Items.GLASS_BOTTLE) && ModConfiguration.bottleMilking)
        {
