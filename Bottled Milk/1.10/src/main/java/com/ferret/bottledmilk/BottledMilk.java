...
public class BottledMilk
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        ModItems.init();
        EntityRegistry.registerModEntity(EntitySplashMilk.class, "splashmilk", 1, this, 80, 3, true);
        EntityRegistry.registerModEntity(EntityLingeringMilk.class, "lingeringmilk", 2, this, 80, 3, true);
    }
