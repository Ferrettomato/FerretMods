 ...
 */
public class ItemLingeringMilk extends Item
{
    public ItemLingeringMilk(String name)
    {
        super();

        this.setMaxStackSize(ModConfiguration.lingeringStackSize);
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if (!worldIn.isRemote)
        {
            EntityLingeringMilk entitypotion = new EntityLingeringMilk(worldIn, playerIn);
